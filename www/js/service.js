...
angular.modlue('starter').factory('TwitterService', function($cordovaOauth, $cordovaOauthUtility, $http, $resource, $q) {
    // 1
    var twitterKey = "STORAGE.TWITTER.KEY";
    var clientId = 'i5dE8x4lab7pdSUA3TDDOekIO';
    var clientSecret = '5frZDVZAdlUsbwnof9PB6aIwfrqsBlY2GjOdLKc4I5Po9xdj11';
